...
import VendorViewSection from '../vendor/VendorViewSection'

export default function EditPurchasePayment({ packagesObject, loading }) {
  const router = Router
                    ...
                    <Controller
                      ...
                      render={({ field, fieldState: { error } }) => (
                        <CustomAutocomplete
                          ...
                          value={purchaseOrders.find(order => order.orderId === field.value)}
                    ...
                    <Controller
                      ...
                      render={({ field, fieldState: { error } }) => (
                        <CustomAutocomplete
                          ...
                          value={purchaseShipments.find(order => order.shipmentId === field.value)}
