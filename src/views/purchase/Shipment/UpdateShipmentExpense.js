...
export default function UpdateShipmentExpense({
  open,
  setOpen,
  vendors,
  setValueFieldByKey,
  ...
  const handleSubmit = () => {
    ...
    setValueFieldByKey('expenses',  expenseId, 'vendorId', selectedVendor?.vendorId)
    setValueFieldByKey('expenses',  expenseId, 'expenseValueCurrency', selectedVendor?.currencyId)
    setOpen(false)
  }
      ...
      >
        <DialogTitle id='alert-dialog-title'>
          <Alert severity='info' icon={false} sx={{ color: 'rgba(0,0,0,0.8)' }}>
            Update Shipment Expense Vendor
          </Alert>{' '}
        </DialogTitle>
