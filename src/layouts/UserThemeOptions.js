...
const UserThemeOptions = () => {
  ...
  return {
    ...
    shadows: mode === 'light' ? [
      ...
      '0px 3px 8px 0px rgba(0, 0, 0, 0.14)',
      '0px 3px 9px 0px rgba(0, 0, 0, 0.15)',
      '0px 4px 10px 0px rgba(0, 0, 0, 0.15)',
      '0px 4px 11px 0px rgba(0, 0, 0, 0.16)',
      '0px 4px 18px 0px rgba(0, 0, 0, 0.1)',
      '0px 4px 13px 0px rgba(0, 0, 0, 0.18)',
      '0px 5px 14px 0px rgba(0, 0, 0, 0.18)',
      '0px 5px 15px 0px rgba(0, 0, 0, 0.2)',
      '0px 5px 16px 0px rgba(0, 0, 0, 0.2)',
      '0px 6px 17px 0px rgba(0, 0, 0, 0.22)',
      '0px 6px 18px 0px rgba(0, 0, 0, 0.22)',
      '0px 6px 19px 0px rgba(0, 0, 0, 0.24)',
      '0px 7px 20px 0px rgba(0, 0, 0, 0.24)',
      '0px 7px 21px 0px rgba(0, 0, 0, 0.26)',
      '0px 7px 22px 0px rgba(0, 0, 0, 0.26)',
      '0px 8px 23px 0px rgba(0, 0, 0, 0.28)',
      '0px 8px 24px 6px rgba(0, 0, 0, 0.28)',
      '0px 9px 25px 0px rgba(0, 0, 0, 0.3)',
      '0px 9px 26px 0px rgba(0, 0, 0, 0.32)',
      '0px 9px 27px 0px rgba(0, 0, 0, 0.32)',
      '0px 10px 28px 0px rgba(0, 0, 0, 0.34)',
      '0px 10px 30px 0px rgba(0, 0, 0, 0.34)'
    ] : [
      'none',
