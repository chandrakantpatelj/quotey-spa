      ...
      variants: [
        {
          ...
          style: ({ theme }) => ({
            // borderColor: hexToRGBA(theme.palette.primary.main, 1),
            '&:hover': {
        ...
        },
        {
          ...
          style: ({ theme }) => ({
            // borderColor: hexToRGBA(theme.palette.success.main, 1),
            '&:hover': {
        ...
        },
        {
          ...
          style: ({ theme }) => ({
            // borderColor: hexToRGBA(theme.palette.error.main, 1),
            '&:hover': {
        ...
        },
        {
          ...
          style: ({ theme }) => ({
            // borderColor: hexToRGBA(theme.palette.warning.main, 1),
            '&:hover': {
        ...
        },
        {
          ...
          style: ({ theme }) => ({
            // borderColor: hexToRGBA(theme.palette.info.main, 1),
            '&:hover': {
