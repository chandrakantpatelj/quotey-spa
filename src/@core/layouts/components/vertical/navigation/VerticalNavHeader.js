...
const VerticalNavHeader = props => {
  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ minHeight: '85.86px' }}>
      <Link href='/' onClick={toggleNavVisibility}>
        {' '}
        <Box component={'img'} src='/warehouse-img/Logo.png' sx={{ maxWidth: '187px', width: '100%' }} />
      </Link>
